...
const PROVIDERS = Object.assign(
  {
    ...
    github_copilot: {
      name: "GitHub Copilot lol",
      logo_name: "github-copilot-symbolic",
      description: getString(
        "AI-powered code completion tool from GitHub.\nRequires a GitHub subscription.",
      ),
      base_url: "https://models.inference.ai.azure.com",
      key_get_url: "https://github.com/features/copilot",
      key_file: "github_copilot_key.txt",
      model: "gpt-4o",
    },
  },
...
class GPTService extends Service {
  ...
  send(msg) {
    ...
    if (this._currentProvider === "github_copilot") {
      // Implement specific logic
      const body = {
        // Ensure your request matches the Azure OpenAI expectations
        ...
        stream: false, // or true if streaming is intended and supported
      };

      const session = new Soup.Session(); // Simplified example
      const message = new Soup.Message({
        method: "POST",
        uri: this._url,
      });

      message.request_headers.append("api-key", this._key);
